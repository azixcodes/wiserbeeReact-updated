...
const CoursesList = (props) => {
    ...
    const {imgesLect,tagLect,headingLect,pragraphLect,durationLect,completedLect} = props;
        ...
        <div className="courseBox d-flex justify-content-start mt-3">
                ...
                <div className="courseDetails">
                    ...
                    <div className="d-flex justify-content-between align-items-center ">
                        <div className="w-50">
                            <div class="progress">
                                <div class="bar" style={{ width: completedLect }}>
                                </div>
                            </div>
                        ...
                        <button type="button" className="btn btn-primary continueBtn">Continue {pauseBtn}</button>
                    </div>
                </div>
            </div>
    );
