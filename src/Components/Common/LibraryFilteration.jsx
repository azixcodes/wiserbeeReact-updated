...
const LibraryFilteration = ({ handleRemoveFliterModal }) => {
  ...
  return (
    <div className="w-100 d-flex flex-column customShadow rounded-md px-4 py-4">
      ...
      {/* Ratings */}
      <div className="d-flex flex-column  w-100 gap-1 mb-4">
        {ratings.map((item, index) => (
          <>
            <div
              ...
              key={index}
            >
              <h4 className="h6 m-0 p-0 fw-bold filterTitle mb-3">
                {item.title}
              </h4>
      ...
      {/* Categories */}
      <div className="d-flex flex-column w-100 gap-3 mb-4">
...
export default LibraryFilteration;
