...
const Courses = () => {
  ...
  return (
    <div className="w-100  d-flex flex-column gap-4">
      ...
      {/* filteration and content section */}
      <div className="d-flex flex-row gap-3 courseFilterWrapper">
        <div className="filterationCourse" ref={filterRef}>
          <div className="d-flex justify-content-between align-items-center">
            ...
            <X className="filterIcon" onClick={handleRemoveFliterModal} />
          </div>
                  ...
                  {toggler.softwareToggler &&
                    item.content.map((content, index) => (
                      <div
                        ...
                        key={index}
                      >
                        <input type="radio" className="p-0 m-0" name="level" />
