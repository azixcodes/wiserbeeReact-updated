...
const Home = () => {
    ...
    return <>
        ...
        <div className="CoursesDetails">
            <h3>My Courses</h3>
            <CoursesList imgesLect={images.courseImges} tagLect={'4D Animation'} headingLect={'Always stay updated in your student portal'} pragraphLect={'Always stay updated in your student portal'} durationLect={'15 Lessons (10h 5m)'} completedLect={'65%'}
            />
        </div>
